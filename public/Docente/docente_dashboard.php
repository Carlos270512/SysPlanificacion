    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="chatAIOffcanvas" aria-labelledby="chatAIOffcanvasLabel">
        ...
        <div class="offcanvas-body d-flex flex-column p-0">
            ...
            <div id="chat-messages" class="flex-grow-1 p-3" style="overflow-y: auto; max-height: calc(100vh - 200px);">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    ¡Hola! Soy tu asistente de IA. Puedes preguntarme cualquier cosa sobre educación, planificación de clases, o cualquier tema que necesites.
            ...
            <ul class="navbar-nav flex-row align-items-center mx-auto">
                <li class="nav-item dropdown mx-2">
                    ...
                    <ul class="dropdown-menu custom-dropdown" aria-labelledby="planificacionDropdown">
                        <li><a class="dropdown-item" href="../planificaciones.php" target="mainFrame">Generar Planificación</a></li>
                ...
                <!-- NUEVO BOTÓN DE IA -->
                <li class="nav-item mx-2">
                    <a class="nav-link custom-nav-link" href="#" data-bs-toggle="offcanvas" data-bs-target="#chatAIOffcanvas">
